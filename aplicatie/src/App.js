...
// import Register from './components/Register';
// import Home from './components/Home';
// import InscriereProiect from './components/InscriereProiect';
// import IncarcareLivrabil from './components/IncarcareLivrabil';
// import VizualizareProiecte from './components/VizualizareProiecte';
// import VizualizareProiecteProfesor from './components/VizualizareProiecteProfesor';
// import SelectieJuriu from './components/SelectieJuriu';
// import VizualizareEchipeProfesor from './components/VizualizareEchipeProfesor';
// import VizualizareNoteProfesor from './components/VizualizareNoteProfesor';
// import { BrowserRouter as Router, Routes, Route, Navigate } from 'react-router-dom';
// import React from 'react';
...
//                       className="link-button"
//                       onClick={() =>
//                         setState((prev) => ({ ...prev, authView: 'register' }))
//                       }
//                     >
//                       Înregistrează-te
//                     </button>
...
//                     setRegisterData={setState}
//                     switchToLogin={() =>
//                       setState((prev) => ({ ...prev, authView: 'login' }))
//                     }
//                   />
//                   <p className="auth-switch">
//                     Ai deja cont?{' '}
...
//               path="/vizualizare-proiecte"
//               element={
//                 <ProtectedRoute element={<VizualizareProiecte />} allowedRoles={['student']} />
//               }
//             />
//             <Route
//               path="/vizualizare-proiecte-profesor"
...
//               path="/selectie-juriu"
//               element={
//                 <ProtectedRoute element={<SelectieJuriu />} allowedRoles={['profesor']} />
//               }
//             />
//             <Route
//               path="/vizualizare-echipe"
//               element={
//                 <ProtectedRoute element={<VizualizareEchipeProfesor />} allowedRoles={['profesor']} />
//               }
//             />
//             <Route
//               path="/vizualizare-note"
//               element={
//                 <ProtectedRoute element={<VizualizareNoteProfesor />} allowedRoles={['profesor']} />
//               }
//             />
//             <Route path="*" element={<Navigate to="/" replace />} />
//           </Routes>
